...
Fortunately for people who are rusty with SQL, and who don't feel like learning both SQL and R, can do all of this using the `diplyr` package in R.
...
The following plot enables us to observe the change to the acceleration in relation to the governmental measures.
...
Let us see how those figures compare with other countries in particular France and Germany.
...
covid_eu %>% 
   ...
   theme(plot.title = element_text(size = 14, vjust = 2, hjust=0.5)) +
   labs (title = "total number of deaths by months", 
